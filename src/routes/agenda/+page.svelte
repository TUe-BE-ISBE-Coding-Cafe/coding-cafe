...
<section class="mx-auto max-w-screen-xl px-8 py-2">
	...
	<h2 class="py-2 text-2xl">UPCOMING SESSIONS</h2>
		...
		>
			...
			<div class="flex h-full flex-col p-2">
				...
				<div class="flex flex-col items-center">
					...
					{/if}
					<a class="mt-2 text-sm font-medium text-gray-600" href={event.speaker_link}
						>{event.speaker}
					</a>
				</div>
			</div>
			...
			<div class="flex h-full flex-col items-center justify-center p-2 pr-4">
				...
				{#if event.calendar}
					<a
						href={event.calendar}
						target="_blank"
						class="text-md inline-block w-full rounded-lg bg-[#C81919] px-4 py-3 text-center font-semibold text-white shadow-lg transition hover:bg-[#a60d25]"
					>
						Add to Calendar
					</a>
				{/if}
